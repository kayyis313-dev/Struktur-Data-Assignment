...
```
Program ini digunakan untuk membangun Multi Linked List yang dilengkapi dengan berbagai fungsi, seperti pembaruan data (update), pencarian (searching), penghapusan (delete), serta pencarian elemen parent dan child. Selain itu, program ini juga mendukung proses penambahan data parent beserta child.


## Unguided

## soal 2. 
<img width="1034" height="74" alt="image" src="https://github.com/user-attachments/assets/cef82b0a-b64d-4fa8-976a-8c5a2e88059a" />
...
<img width="1919" height="1119" alt="image" src="https://github.com/user-attachments/assets/8a31a1f1-3a18-4019-9c91-8cf2bb79133c" />
<img width="1919" height="1117" alt="image" src="https://github.com/user-attachments/assets/8b31dc46-33ec-4325-bbe0-51f6cb58ed35" />
<img width="1919" height="1131" alt="image" src="https://github.com/user-attachments/assets/63ee8613-3536-45bc-946d-5eb6cc0500fd" />

### Output soal 2 :
<img width="940" height="124" alt="image" src="https://github.com/user-attachments/assets/3d84df60-2289-4d1c-9fea-1ca17d60beeb" />

Program ini mengimplementasikan Multi Linked List yang memungkinkan satu node induk memiliki beberapa node anak. Struktur ini mendukung proses penambahan, penghapusan, dan penampilan data induk beserta data anak secara terstruktur.

### soal 3. 
<img width="1097" height="851" alt="Screenshot 2025-12-26 144244" src="https://github.com/user-attachments/assets/8190b136-658d-4990-8ca3-e0732dea7c57" />
<img width="993" height="888" alt="Screenshot 2025-12-26 144310" src="https://github.com/user-attachments/assets/ed9fe822-c9ee-4d96-8b4e-5eb150317df1" />
<img width="920" height="877" alt="Screenshot 2025-12-26 144326" src="https://github.com/user-attachments/assets/510e0b5a-4635-4b1e-8dea-234591651b93" />
<img width="1056" height="613" alt="Screenshot 2025-12-26 144341" src="https://github.com/user-attachments/assets/5eaa4210-1107-4fbd-8118-3e1e002d63a4" />
...
Program ini mengimplementasikan Circular Singly Linked List, di mana node terakhir terhubung kembali ke node pertama. Program mendukung operasi penambahan data di awal, akhir, dan setelah node tertentu, pencarian data berdasarkan NIM, serta penampilan seluruh data mahasiswa secara berurutan.


### Kesimpulan
Pada materi tree ini, Materi yang dipelajari mencakup implementasi Multi Linked List dan Circular Linked List sebagai struktur data dinamis. Multi Linked List digunakan untuk merepresentasikan hubungan induk dan anak, sedangkan Circular Linked List membentuk struktur melingkar tanpa akhir. Kedua struktur ini mendukung operasi dasar seperti penambahan, penghapusan, pencarian, dan penelusuran data secara efisien dan terstruktur.
